...
Enable audit login event for both correct login and failed.
...
## Step 3: Analyze Logs in Event Viewer

Go to Event Viewer in Windows. On the Windows machine, open **Event Viewer** and navigate to:
...
## Step 4: Filter Using XML XPath Query
